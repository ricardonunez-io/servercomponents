export default function GithubLink() {
  return (
    <a
      href="https://github.com/ricardonunez-io/servercomponents"
      aria-label="View source on GitHub"
      className="flex items-center gap-x-2 sm:gap-x-3 text-sm text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors no-underline"
      target="_blank"
    ...
    >
      ...
      <div className="hidden md:flex my-0">View Source</div>
    </a>
  );
}
