  ...
  return (
    <>
      <div className="relative scale-100 lg:scale-90">
        <div className="relative mx-2 max-h-[75vh] select-none overflow-hidden dark:bg-neutral-950 bg-neutral-50 border-2 border-neutral-300 dark:border-neutral-600 h-fit w-full rounded-xl md:mx-4 lg:mx-auto lg:max-w-4xl">
          <div className="flex items-center justify-center border-b-2 border-neutral-300 dark:border-neutral-600">
          ...
          <div className="pb-2 md:pb-4">
            <div className="h-[25vh] bg-white sm:h-[38vh] hidden md:flex">
              <div className="relative flex overflow-hidden rounded bg-white text-neutral-600 md:rounded-lg h-[25vh] sm:h-[38vh]">
                <div className="border-r border-neutral-100 bg-neutral-50">
                  <div className="p-[5.7px] lg:p-4">
                    <div className="flex items-center text-[color:#23BF1F]">
                      ...
                      <div className="font-display text-xs font-extrabold md:text-base">
                        Fakebooks
                      </div>
                    </div>
                    ...
                    <div className="font-bold text-neutral-800">
                      ...
                      <div className="my-[1.4px] py-[1.4px] px-[2.8px] pr-4 text-[length:7px] md:my-1 md:py-1 md:px-2 md:pr-16 md:text-[length:10px] lg:text-[length:14px] rounded bg-neutral-100 md:rounded-md">
                        Sales
                      </div>
                      <div className="my-[1.4px] py-[1.4px] px-[2.8px] pr-4 text-[length:7px] md:my-1 md:py-1 md:px-2 md:pr-16 md:text-[length:10px] lg:text-[length:14px] undefined">
                        Expenses
                ...
                <div className="flex-1">
                  <div className="relative h-full p-3 md:p-10">
                    ...
                    <div className="flex gap-2 border-b border-neutral-100 pb-1 text-[length:5px] font-medium text-neutral-400 md:gap-4 md:pb-4 md:text-[length:14px]">
                      <div>Overview</div>
                    ...
                    <div className="relative">
                      <div className="flex items-center justify-between gap-1 md:gap-4">
                        <div className="">
                          <div className="text-[length:5px] font-medium uppercase leading-[8.5px] text-neutral-400 md:text-[12px] md:leading-[24px]">
                            Overdue
                          </div>
                      ...
                      <div className="flex rounded border border-neutral-100 md:rounded-lg">
                        <div className="w-1/2 border-r border-neutral-100">
                          <div className="border-b border-neutral-50 py-[4.2px] md:py-3 mx-[5.7px] border-transparent md:mx-4">
                            ...
                            <div className="flex justify-between text-[length:4.2px] font-medium leading-[6px] text-neutral-400 md:text-[length:12px] md:leading-4">
                              <div>1995</div>
                              <div className="uppercase text-red-400">
                                Overdue
                              </div>
                            </div>
                          </div>
                          <div className="border-b border-neutral-50 py-[4.2px] md:py-3 bg-neutral-50 px-[5.7px] md:px-4">
                            <div className="flex justify-between text-[length:5px] font-bold leading-[8.5px] md:text-[length:14px] md:leading-6">
                              <div>Stankonia</div>
                              <div>$8,000</div>
                            </div>
                        ...
                        <div className="w-1/2">
                          <div className="relative p-3 md:p-10">
                            ...
                            <div className="flex justify-between border-t border-neutral-100 py-[5.7px] text-[5px] leading-[9px] md:py-4 md:text-[14px] md:leading-[24px] ">
                              <div>Pro Plan</div>
                              <div>$6,000</div>
                            </div>
                            <div className="flex justify-between border-t border-neutral-100 py-[5.7px] text-[5px] leading-[9px] md:py-4 md:text-[14px] md:leading-[24px] ">
                            ...
                            <div className="flex justify-between border-t border-neutral-100 py-[5.7px] text-[5px] leading-[9px] md:py-4 md:text-[14px] md:leading-[24px] font-bold">
                              <div>Net Total</div>
                              <div>$8,000</div>
                            </div>
                          </div>
            ...
            <div className="relative border-2 border-green-400 bg-green-400 bg-opacity-[15%] rounded-lg p-2 mx-2">
              <div className="absolute top-0 right-0 left-16 flex justify-around sm:left-28">
                <div className="h-1 w-[1px] bg-neutral-300"></div>
                <div className="h-1 w-[1px] bg-neutral-300"></div>
                <div className="h-1 w-[1px] bg-neutral-300"></div>
                <div className="h-1 w-[1px] bg-neutral-300"></div>
                <div className="h-1 w-[1px] bg-neutral-300"></div>
                ...
                <div className="h-1 w-[1px] bg-neutral-300"></div>
                <div className="h-1 w-[1px] bg-neutral-300"></div>
                <div className="h-[6px] w-[1px] bg-neutral-50"></div>
                <div className="h-1 w-[1px] bg-neutral-300"></div>
                <div className="h-1 w-[1px] bg-neutral-300"></div>
                <div className="h-1 w-[1px] bg-neutral-300"></div>
                <div className="h-1 w-[1px] bg-neutral-300"></div>
              ...
              <div className="h-4"></div>
              <div>
                <div className="flex items-center justify-center border-b border-neutral-600 last:border-b-0">
                  <div className="w-16 sm:w-28 text-xs sm:text-sm ">
                    document
                  </div>
                  <div className="relative flex-1">
                    <div
                      className="h-1 sm:h-2 bg-green-400"
                      style={{ width: "10%", marginLeft: "0%" }}
                    ></div>
                  </div>
                </div>
                <div className="flex items-center justify-center border-b border-neutral-600 last:border-b-0">
                  <div className="w-16 text-xs sm:w-28 sm:text-sm ">
                    root.js
                  </div>
                  <div className="relative flex-1">
                    <div
              ...
              <div className="absolute top-0 right-0 left-16 h-full sm:left-28">
                <div
                  ...
                  style={{ left: "98.318713%" }}
                >
                  <svg
                    className="-ml-1 w-2 text-blue-400"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 7 14"
                  >
      ...
      <div className="flex items-center text-sm text-center mt-4 lg:mt-0 lg:mb-4 px-8">
        The green highlighted area at the bottom is an example of a similar
        network waterfall where each part of the page is staggered behind the
        last.
      </div>
    </>
  );
