...
export default function ServerRenderingAnimation({
  caption,
}: {
  caption: string;
}) {
      ...
      <div className="flex justify-between items-center overflow-hidden">
        <div className="flex justify-between items-center w-full">
          <div className="grid place-items-center mr-4 sm:mr-6 md:mr-8 lg:mr-10">
            ...
            >
              <span className="font-mono text-lg sm:text-xl md:text-2xl border-2 border-neutral-500 dark:border-neutral-600 rounded-lg p-2 bg-neutral-50 dark:bg-neutral-950">
                `&lt;html/&gt;`
              </span>
            </m.div>
            ...
            <svg
              className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 opacity-0 text-sky-500 dark:text-sky-400"
              ref={iconScope}
              viewBox="0 0 19 18"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            ...
            <div>
              ...
              >
                ...
                <span className="text-[#B392F0]">renderToString</span>
                ()
              </div>
            </div>
          </div>
          <div className="dark:bg-neutral-950 bg-neutral-50 border-2 border-neutral-300 dark:border-neutral-600 h-fit max-[475px]:max-h-64 w-full rounded-xl p-3 px-0 relative">
              ...
              <div>
                ...
                >
                  <div className="flex gap-x-1 items-center relative">
                    ...
                    <div className="bg-neutral-300 dark:bg-neutral-600 h-3 rounded-md w-12 max-[475px]:h-2" />
                  </div>
                  <div className="hidden md:flex items-center gap-x-2 lg:gap-x-4 relative">
                    <div className="bg-neutral-300 dark:bg-neutral-600 h-3 rounded-md w-8" />
                    <div className="bg-neutral-300 dark:bg-neutral-600 h-3 rounded-md w-8" />
                  </div>
                  <div className="hidden md:flex items-center relative gap-x-4">
                    <div className="text-neutral-600/50 dark:text-neutral-300/50 text-sm font-medium">
                      Log In
                    </div>
                    <div className="text-neutral-600/50 dark:text-neutral-300/50 text-sm font-medium">
                      Sign Up
                  ...
                  <div className="relative md:hidden -mt-1">
                    <MenuIcon className="stroke-neutral-300/50" />
                  </div>
                </div>
                <div className="grid grid-cols-2 pt-6 space-x-2">
                  <div className="opacity-0" ref={copyScope}>
                    <div className="relative">
                      <div className="mt-2 bg-neutral-300 dark:bg-neutral-600 h-3 rounded-sm w-20 max-w-full max-[475px]:h-1.5 max-[475px]:mt-1" />
                      <div className="mt-4 bg-neutral-300 dark:bg-neutral-600 h-6 rounded-md w-28 max-w-full max-[475px]:h-3 max-[475px]:mt-2" />
                      <div className="mt-2 bg-neutral-300 dark:bg-neutral-600 h-3 rounded-sm w-36 max-w-full max-[475px]:h-1.5 max-[475px]:mt-1" />
                      <div className="mt-2 bg-neutral-300 dark:bg-neutral-600 h-3 rounded-sm w-48 max-w-full max-[475px]:h-1.5 max-[475px]:mt-1" />
                      <div className="mt-2 bg-neutral-300 dark:bg-neutral-600 h-3 rounded-sm w-32 max-w-full max-[475px]:h-1.5 max-[475px]:mt-1" />
                    </div>
                  ...
                  <div
                    ...
                    ref={heroScope}
                  >
                    <div className="mt-2 bg-neutral-300 dark:bg-neutral-600 h-24 sm:h-32 md:h-full rounded-md w-full relative"></div>
                  </div>
                </div>
              </div>
              <div className="mt-12 hidden md:grid">
                <div className="relative pt-4 opacity-0" ref={logoCloudScope}>
                  <div className="mx-auto h-3 rounded-sm bg-neutral-300 dark:bg-neutral-600 w-32" />
                  <div className="mt-4 flex gap-x-4 justify-center">
                    <div className="rounded-full w-6 h-6 bg-neutral-300 dark:bg-neutral-600" />
                    <div className="rounded-full w-6 h-6 bg-neutral-300 dark:bg-neutral-600" />
                    <div className="rounded-full w-6 h-6 bg-neutral-300 dark:bg-neutral-600" />
                    <div className="rounded-full w-6 h-6 bg-neutral-300 dark:bg-neutral-600" />
                    <div className="rounded-full w-6 h-6 bg-neutral-300 dark:bg-neutral-600" />
                    <div className="rounded-full w-6 h-6 bg-neutral-300 dark:bg-neutral-600 hidden sm:flex" />
                    <div className="rounded-full w-6 h-6 bg-neutral-300 dark:bg-neutral-600 hidden md:flex" />
                    <div className="rounded-full w-6 h-6 bg-neutral-300 dark:bg-neutral-600 hidden lg:flex" />
                  </div>
                </div>
              </div>
            </div>
