...
export default function Browser() {
  ...
  return (
    <LazyMotion features={domAnimation}>
      <m.div
        aria-hidden="true"
        className="dark:bg-neutral-950 bg-neutral-50 border-2 border-neutral-300 dark:border-neutral-600 h-fit w-full rounded-xl p-3 px-0 relative bg-blend-exclusion z-50"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 1.5, ease: "easeOut" }}
      >
        <div className="flex w-full rounded-t-xl justify-between border-b-2 border-neutral-300 dark:border-neutral-600">
          ...
          <div>
            <div className="flex items-center justify-between">
              <div className="flex gap-x-1 items-center relative">
                ...
                <div className="bg-neutral-300 dark:bg-neutral-600 h-3 rounded-md w-12" />
              </div>
            ...
            <div className="grid grid-cols-2 pt-6 space-x-2">
              <div>
                <div className="relative">
                  ...
                  <div className="absolute inset-0 px-2 pt-3">
                    <div className="mt-2 bg-neutral-300 dark:bg-neutral-600 h-3 rounded-sm w-20 max-w-full" />
                    <div className="mt-4 bg-neutral-300 dark:bg-neutral-600 h-6 rounded-md w-28 max-w-full" />
                    <div className="mt-2 bg-neutral-300 dark:bg-neutral-600 h-3 rounded-sm w-36 max-w-full" />
                    <div className="mt-2 bg-neutral-300 dark:bg-neutral-600 h-3 rounded-sm w-48 max-w-full" />
                    <div className="mt-2 bg-neutral-300 dark:bg-neutral-600 h-3 rounded-sm w-32 max-w-full" />
                  </div>
                </div>
              ...
              <div className="relative h-40 md:h-64 w-full">
                <div className="mt-2 bg-neutral-300 dark:bg-neutral-600 h-full rounded-md w-full relative">
                  <m.svg
                    initial="hidden"
                    animate="visible"
