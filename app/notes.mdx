...
But what if your component is awaiting for something, but the parent component updates state so synchronicity is necessary, i.e. typing into an input.
