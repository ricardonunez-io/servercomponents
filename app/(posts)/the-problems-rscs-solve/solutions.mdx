...
[<RemixLogo width={20} /> Remix's website](https://remix.run) includes a great visualization of what this waterfall might look like in the real world:
...
<BlogFooter previousPost="What are React Server Components?" previousHref="/what-are-react-server-components" nextPost="Home Page" nextHref="/"  />
