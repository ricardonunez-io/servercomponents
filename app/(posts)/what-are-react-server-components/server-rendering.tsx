		...
		<div className="my-4 h-full">
			<div className="flex justify-between items-center overflow-hidden">
				<div className="flex justify-between items-center w-full">
					...
					>
						<div className="flex w-full rounded-t-xl justify-between border-b-2 border-slate-300 dark:border-slate-600 relative">
			...
			<div className="flex items-center">
				<div className="mr-3">
					...
					<button
						...
						className="group w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 bg-gray-800 rounded-xl border-2 border-gray-600 text-white grid place-items-center hover:bg-gray-700 disabled:opacity-50 disabled:bg-gray-950 active:scale-90 transition-all transform-gpu duration-150 relative"
					>
